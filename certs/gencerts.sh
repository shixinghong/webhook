...
EOF
#
#[root@ip-172-31-2-137 certs]# grep -Ev "^#|^$" openssl.cnf  > server.conf
#[root@ip-172-31-2-137 certs]# vim server.c
#[root@ip-172-31-2-137 certs]# vim server.conf
#[root@ip-172-31-2-137 certs]# vim openssl.cnf
#[root@ip-172-31-2-137 certs]# cat server.conf
#HOME			= .
#RANDFILE		= $ENV::HOME/.rnd
#oid_section		= new_oids
#[ new_oids ]
...
openssl req -new -key serverKey.pem -out server.csr -subj "/CN=webhook.kube-system.svc" -config server.conf
